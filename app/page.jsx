  ...
  return (
    <div>
      ...
      <section className="pb-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 md:gap-35 items-center relative z-10">
          {/* Left content */}
          <div className="text-center sm:text-left">
            <div className="mb-6">
              <span className="text-gray-500 font-light tracking-wide mb-6">
                spotx<span className="text-pink-400">*</span>
              </span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-[0.95] tracking-tight">
              ...
              create amazing
              <br />
              <span className="bg-linear-to-r from-blue-400 via-pink-400 to-orange-400 bg-clip-text text-transparent">
                events.
              </span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-lg font-light">
              Whether you&apos;re hosting or attending, SpotX makes every event
          ...
          <div className="relative block pl-5 pr-5">
            {/* <Image
              src="/h.png"
              // src="/hero.gif"
              alt="react meetup"
